...
public class ValidationTests {
	...
	public void questionOneCancelledFlights() {
		...
		Double percent = Double.parseDouble( answer.split(",")[1].substring(0, 3) );	// Answer to the nearest 0.1 %
		
		assertEquals( "AA", carrier.toUpperCase(),  "Carrier is wrong, should be AA");
		assertEquals( 1.3, percent,  0.1, "Percent cancelled is wrong; should be around 1.3%");
	}
	...
	public void questionSevenDelays() {
		...
		assertEquals( 59, Integer.parseInt(answer),  "Incorrect answer; Expected 59");
	}
